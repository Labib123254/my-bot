...
def handle_menu(message):
    ...
    if text == '📖 কাজ ▸':
        ...
        balance_msg = (
            ...
            f"📈 **মোট ইনকাম:** {total_inc:.2f} BDT\n"
            f"✅ **সম্পন্ন কাজ:** {comp_tasks} টি\n"
            f"⏳ **পেন্ডিং কাজ:** {pend_tasks} টি"
        )
        ...
        support_msg = "🧐 **যেকোনো সমস্যায় নিচের লিংকে যোগাযোগ করুন:**"
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("📩 সাপোর্টে যোগাযোগ করুন", url=ADMIN_SUPPORT_URL))
